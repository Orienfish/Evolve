...
class VICReg(nn.Module):
    def __init__(self,
        ...
        self.projector = nn.Sequential(  # projector
            nn.Linear(backbone.output_dim, proj_hidden_dim),
    ...
    def forward(self, x, y):
        ...
        Args:
            x: raw augmented vector of shape [bsz, ...].
            y: raw augmented vector of shape [bsz, ...].
        Returns:
            A loss scalar.
        """
        z1 = self.projector(self.backbone(x))
        z2 = self.projector(self.backbone(y))
