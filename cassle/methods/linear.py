...
class LinearModel(pl.LightningModule):
    def __init__(
        ...
        #log_name: str = None,  # For evaluate expert's linear accuracy
        **kwargs,
    ):
        ...
        # self.classifier = nn.Linear(self.backbone.module.out_features, num_classes)  # For evaluate expert's linear accuracy
        ...
        self.log_dir = ckpt_dir_path
        #self.log_name = log_name  # For evaluate expert's linear accuracy
    ...
    def validation_epoch_end(self, outs: List[Dict[str, Any]]):
        ...
        # with open('acc_{}.txt'.format(self.log_name), 'a+') as f:  # For evaluate expert's linear accuracy
        with open(os.path.join(self.log_dir, 'linear_result.txt'), 'a+') as f:
            f.write('{val_loss},{val_acc1},{val_acc5}\n'.format(
